```ipynb
{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "HEkRJlwVTxyx",
    "outputId": "da9c81c9-ca28-4ded-ddbc-dede5ca824e7"
   },
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "1459  1460          20         3         75.0     9937   Pave   NaN      Reg   \n",
       "\n",
       "     LandContour Utilities  ... PoolArea PoolQC  Fence MiscFeature MiscVal  \\\n",
       "0            Lvl    AllPub  ...        0    NaN    NaN         NaN       0   \n",
       "1            Lvl    AllPub  ...        0    NaN    NaN         NaN       0   \n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "rJIQdphvcc_M",
    "outputId": "c7d1ebeb-f4cf-4a66-ec30-fa7959642776"
   },
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       " (dtype('int64'), 'BsmtFinSF1'),\n",
       " (dtype('O'), 'BsmtFinType2'),\n",
       " (dtype('int64'), 'BsmtFinSF2'),\n",
       " (dtype('int64'), 'BsmtUnfSF'),\n",
       " (dtype('int64'), 'TotalBsmtSF'),\n",
       " (dtype('O'), 'Heating'),\n",
       " (dtype('O'), 'HeatingQC'),\n",
       " (dtype('O'), 'CentralAir'),\n",
       " (dtype('O'), 'Electrical'),\n",
       ...
       " (dtype('int64'), 'BsmtFullBath'),\n",
       " (dtype('int64'), 'BsmtHalfBath'),\n",
       ...
       " (dtype('int64'), 'GarageCars'),\n",
       " (dtype('int64'), 'GarageArea'),\n",
       " (dtype('O'), 'GarageQual'),\n",
       " (dtype('O'), 'GarageCond'),\n",
       " (dtype('O'), 'PavedDrive'),\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "bpUN-_G6mWI2",
    "outputId": "3c35abee-ac75-4eef-9c04-fb189f6ab89a"
   },
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0        1          60         3         65.0     8450  b'Pave'  b'nan'   \n",
       "1        2          20         3         80.0     9600  b'Pave'  b'nan'   \n",
       "2        3          60         3         68.0    11250  b'Pave'  b'nan'   \n",
       "3        4          70         3         60.0     9550  b'Pave'  b'nan'   \n",
       "4        5          60         3         84.0    14260  b'Pave'  b'nan'   \n",
       "...    ...         ...       ...          ...      ...      ...     ...   \n",
       "1455  1456          60         3         62.0     7917  b'Pave'  b'nan'   \n",
       "1456  1457          20         3         85.0    13175  b'Pave'  b'nan'   \n",
       "1457  1458          70         3         66.0     9042  b'Pave'  b'nan'   \n",
       "1458  1459          20         3         68.0     9717  b'Pave'  b'nan'   \n",
       "1459  1460          20         3         75.0     9937  b'Pave'  b'nan'   \n",
       "\n",
       "     LotShape LandContour  Utilities  ... PoolArea  PoolQC     Fence  \\\n",
       "0      b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "1      b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "2      b'IR1'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "3      b'IR1'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "4      b'IR1'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "...       ...         ...        ...  ...      ...     ...       ...   \n",
       "1455   b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "1456   b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'  b'MnPrv'   \n",
       "1457   b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'  b'GdPrv'   \n",
       "1458   b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "1459   b'Reg'      b'Lvl'  b'AllPub'  ...        0  b'nan'    b'nan'   \n",
       "\n",
       "     MiscFeature MiscVal MoSold YrSold  SaleType  SaleCondition  SalePrice  \n",
       "0         b'nan'       0      2   2008     b'WD'      b'Normal'     208500  \n",
       "1         b'nan'       0      5   2007     b'WD'      b'Normal'     181500  \n",
       "2         b'nan'       0      9   2008     b'WD'      b'Normal'     223500  \n",
       "3         b'nan'       0      2   2006     b'WD'     b'Abnorml'     140000  \n",
       "4         b'nan'       0     12   2008     b'WD'      b'Normal'     250000  \n",
       "...          ...     ...    ...    ...       ...            ...        ...  \n",
       "1455      b'nan'       0      8   2007     b'WD'      b'Normal'     175000  \n",
       "1456      b'nan'       0      2   2010     b'WD'      b'Normal'     210000  \n",
       "1457     b'Shed'    2500      5   2010     b'WD'      b'Normal'     266500  \n",
       "1458      b'nan'       0      4   2010     b'WD'      b'Normal'     142125  \n",
       "1459      b'nan'       0      6   2008     b'WD'      b'Normal'     147500  \n",
       "\n",
       "[1460 rows x 81 columns]"
      ]
     },
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "gpO4rq48Zp5R",
    "outputId": "d0e36b1f-9c42-4320-a2fc-b72bbf7b7dc0"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "jnhbcmO7m5QC",
    "outputId": "74941586-2686-47db-d08a-b6747659d487"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "AyPh-KyPm7GF",
    "outputId": "491dc88b-100c-4ed2-a0e4-68e6c158e8d2"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "NmbbT2HYqPe8",
    "outputId": "b6ae77b8-1214-46b4-d75b-e5dcea1ab287"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "k1TCl165rhF6",
    "outputId": "da868220-786a-478b-def2-424f449e8778"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "nQ3TW4jDrtQc",
    "outputId": "4cd3c858-131d-4058-ecb1-9b396f22a130"
   },
   "outputs": [
    {
     "data": {
 ...
 "metadata": {
  "colab": {
   "name": "Ames House Price Prediction .ipynb",
   "provenance": []
  },
  "kernelspec": {
